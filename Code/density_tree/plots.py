...
def plotData(data, title, clusters = None, save=False, labels=True, minRange=1, maxRange=100, covariance = 2):
    """
...
def plotData_tree_split(clusters, linesX, linesY, title, labels=True, minRange=1, maxRange=100, covariance = 2):
    """
    Plot the clustered data
    """
    fig, ax = plt.subplots()
